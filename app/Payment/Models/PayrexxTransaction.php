...
class PayrexxTransaction extends Model
{
    // waiting | confirmed | cancelled | declined | authorized | reserved | refunded | refund_pending | partially_refunded | chargeback | error | uncaptured
    ...
    const TO_COMPLETE = 'complete';  # If the account checks passed, we have captured the payment.
    const TO_CANCELLED = 'cancelled';
    const TO_FAILED = 'failed';

    protected $guarded = ['id'];

    protected $table = 'payrexx_transactions';
