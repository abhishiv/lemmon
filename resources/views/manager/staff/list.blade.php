...
@section('content')
    ...
    <div class="table-header">
        <div class="row">
            <div class="col-4"><h2 class="title"> @lang('labels.staff') <span class="summary"></span></h2></div>
            <div class="status offset-3 col-5">
                <div class="status-all">
                    <select autocomplete="off" name="status" class="status__change" id="list_staff_status">
    ...
    <table class="table" id="staff-table" data-table-url="{{route('manager.staff.data.table')}}">
        <thead>
        <tr>
            <th>
                @lang('labels.name')
    ...
    <div class="table-footer">
        <div class="button-container">
            <a href="{{ route('manager.staff.create') }}" class="primary-button">
                @lang('labels.add-staff')
            </a>
        </div>
    </div>
@endsection
