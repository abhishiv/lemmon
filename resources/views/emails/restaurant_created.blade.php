    ...
    <div class="email"
        ...
        <div class="email-body"
            ...
            <span class="email-title"
                  style="color: #000; font-weight: 700; font-size: 17px;"> @lang('labels.welcome')</span>
            <p class="email-text" style="color: #000;">@lang('labels.hello'), <br>@lang('labels.thank-you-sign-up') </p>
