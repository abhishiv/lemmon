...
@section('content')
    ...
    <div class="email"
        ...
        <div class="email-body"
            ...
            <p class="email-text" style="color: #000;">Nom du client : {{ $order->pickupDetails->first_name }} {{ $order->pickupDetails->last_name }}</p>
            <p class="email-text" style="color: #000;">Type de commande : À emporter  </p>
            <p class="email-text" style="color: #000;">Date et heure de retrait prévues : {{ $order->pickupDetails->day }} / {{ $order->pickupDetails->time }}</p>
