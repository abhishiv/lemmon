...
@section('content')
    ...
    <div class="email"
        ...
        <div class="email-body"
            ...
            <p class="email-title" style="font-weight: 700; font-size: 15px; color: #000;">@lang('labels.bonjour'), {{ $order->deliveryInformation->first_name }} {{ $order->deliveryInformation->last_name }}</p>
            ...
            <p class="email-text" style="color: #000;">Adresse de livraison :{{ $order->deliveryInformation->street }}, {{ $order->deliveryInformation->city }}</p>
            ...
            <p class="email-text" style="color: #000;">La livraison sera effectuée dans environ 50 minutes</p>
